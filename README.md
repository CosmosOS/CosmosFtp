...
```PM
Install-Package CosmosFtpServer -Version 1.0.5
```

```PM
dotnet add PROJECT package CosmosFtpServer --version 1.0.5
```
...
```
<ItemGroup>
    <PackageReference Include="CosmosFtpServer" Version="1.0.5" NoWarn="NU1604;NU1605" />
</ItemGroup>
```
