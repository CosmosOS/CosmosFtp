...
```PM
Install-Package CosmosFtpServer -Version 1.0.3
```

```PM
dotnet add PROJECT package CosmosFtpServer --version 1.0.3
```
...
```
<ItemGroup>
    <PackageReference Include="CosmosFtpServer" Version="1.0.3" NoWarn="NU1604;NU1605" />
</ItemGroup>
```
